...
{
    [TestFixture]
    public class PokemonBasicInformationTranslatedRouteTests
    {
        ...
        [Test]
        public async Task ShouldReturnCorrectTranslatedPokemonBasicInformationFromExistingPokemon()
        {
        ...
        public async Task ShouldGetNotFoundStatusCodeFromNonExistingPokemon()
        {
            ...
            var response = await _client.GetAsync($"/pokemon/translated/{pokemonName}", _tokenSource.Token);
